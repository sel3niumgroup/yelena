...
public class TestBase {
	...
	/*
	 * public static Properties config = new Properties(); public File f; public
	 * FileInputStream FI;
	 * 
	 * 
	 ...
	 * File(System.getProperty("user.dir")+"/src/main/java/config/config.properties"
	 * ); FI = new FileInputStream(f); config.load(FI); }
	 */
